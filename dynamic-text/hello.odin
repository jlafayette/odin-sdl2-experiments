...
game := Game{text_input = "Try typing something... ", text_size_index = 3}
...
main :: proc() {
    ...
    game_loop : for {
        ...
        text.draw(text_drawers[game.text_size_index], &game.text_input, text.Pos{100, 100}, SCREEN_WIDTH-200)
